...
Route::post('auth', [LoginController::class, 'login'])->name('postAuth');
...
Route::post('register', [LoginController::class, 'create'])->name('postRegister');

Route::get('verify', [VerificationCodeController::class, 'verifyCodeView'])->name('verify');
Route::post('verify', [VerificationCodeController::class, 'validateCode'])->name('postVerify');
